...
def simplex(x, alpha, con):
    ...
    A = np.array([[alpha**2, alpha, 1], [(1.05*alpha)**2, 1.05*alpha, 1], [(0.95*alpha)**2, 0.95*alpha, 1]])
...
np.savetxt('sol'+str(n)+'func'+str(con)+'ite'+str(itetation)+'alpha=0.05.csv', sol, delimiter=",")
