...
market = Market(objective_function=objective_function, domain=domain, demander_number=200, supplier_number=50,
...
max_value = 0
best_place = 0
history_np_array = np.array([[-np.inf, -np.inf, -np.inf]])
